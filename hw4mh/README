// Assignment Instructions: Convert the coding challenges #2, #3, and #4. Download coding challenges #2, #3, and #4 into web apps. For each, create HTML and CSS that takes user input, calls the appropriate JavaScript functions and outputs the result on the HTML page.
...
// const scorePandas = (96 + 108 + 89) / 3;
// const scoreKoalas = (88 + 91 + 110) / 3;
// console.log(scorePandas, scoreKoalas);

// if (scorePandas > scoreKoalas) {
//   console.log('Pandas win the trophy 🏆');
// } else if (scoreKoalas > scorePandas) {
//   console.log('Koalas win the trophy 🏆');
// } else if (scorePandas === scoreKoalas) {
//   console.log('Both win the trophy!');
// }

// let avgScore = function(s1, s2, s3) {
