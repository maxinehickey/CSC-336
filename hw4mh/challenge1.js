// I realized that I don't need this one but wanted to submit it anyways
...
calculateButton.addEventListener("click", ()=>{ // this is what happens when the button is clicked
    ...
    if(BMIMark < BMIJohn){ //if else statement to determine how the results are printed
        statement.innerText = "John has a higher BMI than Mark";    
    }else if((BMIMark > BMIJohn)){
        statement.innerText = "Mark has a higher BMI than John";
    }else if((BMIMark = BMIJohn)){
